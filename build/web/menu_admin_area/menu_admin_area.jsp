        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset nav-lateral-list-menu">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a href="menu_admin_area.jsp"><i class="zmdi fa fa-home zmdi-hc-fw"></i>&nbsp;&nbsp; INICIO</a>
                    </li>                   
                    <li>
                        <div class="dropdown-menu-button">
                            <i class="zmdi fa fa-sign-out  zmdi-hc-fw"></i>&nbsp;&nbsp;ASIGNAR... <i class="zmdi zmdi-chevron-down pull-right zmdi-hc-fw"></i></div>
                        <ul class="list-unstyled">
                            <li><a href="Asignar_titulacion.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Titulacion Instructor</a></li>
                        </ul>
                    </li>                    
                    <li>
                        <div class="dropdown-menu-button"><i class="zmdi fa fa-check-square-o zmdi-hc-fw"></i>ACTUALIZAR/ELIMINAR <i class="zmdi zmdi-chevron-down pull-right zmdi-hc-fw"></i></div>
                        <ul class="list-unstyled">
                            <li><a href="Consultar_instructor_titulacion.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Titulacion Asignada</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
