                ...
                <div class="header-hidden-inner container">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <p>
                                <small>NOTA: Seleccion no es persistente.</small>
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-inline user-menu pull-right">
                                <li >                 <i  title="Inicio" class="fa-2 fa-home text-primary"></i>            <a title="Inicio" href="index_inicio.jsp" class="text-uppercase">Inicio</a></li>
                                <li class=""><i  title="Recuperar Clave" class="fa-2 fa-unlock text-primary"></i> <a title="Recuperar Clave" href="recuperar_clave.jsp" class="text-uppercase">Recuperar clave</a></li>
                                <li class="hidden-xs"><i  title="Iniciar Sesion" class="fa-2 fa-sign-in text-primary"></i> <a title="Iniciar Sesion" href="index.jsp" class="text-uppercase">Iniciar sesion</a></li>
