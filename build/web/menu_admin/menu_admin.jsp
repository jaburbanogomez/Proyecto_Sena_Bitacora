        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset nav-lateral-list-menu">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a href="menu_admin.jsp"><i class="zmdi fa fa-home zmdi-hc-fw"></i>&nbsp;&nbsp; INICIO</a>
                    </li>
                    <li>
                        <div class="dropdown-menu-button">
                            <i class="zmdi material-icons  zmdi">library_add</i> &nbsp;&nbsp; REGISTRAR... <i class="zmdi zmdi-chevron-down pull-right zmdi-hc-fw"></i></div>
                        <ul class="list-unstyled">
                            <li><a href="registrar_regionales.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Registrar Regionales</a></li>
                            <li><a href="registrar_centros.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Registrar Centros</a></li>
                            <li><a href="registrar_areas.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Registrar Areas</a></li>
                            <li><a href="registrar_titulaciones.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Registrar Titulaciones</a></li>
                            <li><a href="registrar_fichas.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Registrar Fichas</a></li>
                            <li><a href="registrar_cordinador.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Registrar Cordinador</a></li>
                            <li><a href="registrar_admin_area.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Registrar Admin Area</a></li>
                            <li><a href="registrar_instructor.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Registrar Instructor</a></li>
                            <li><a href="Registrar_Aprendices.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Registrar Aprendices</a></li>
                        </ul>
                    </li>   
                    <li>
                        <div class="dropdown-menu-button"><i class="zmdi fa fa-upload zmdi-hc-fw"></i>&nbsp;&nbsp; SUBIR ... <i class="zmdi zmdi-chevron-down pull-right zmdi-hc-fw"></i></div>
                        <ul class="list-unstyled">
                            <li><a href="Subir_Instructores.jsp"><i class="zmdi fa fa-arrow-circle-o-up zmdi-hc-fw"></i>Instructores</a></li>
                            <li><a href="Subir_Aprendices.jsp"><i class="zmdi fa fa-arrow-circle-o-up zmdi-hc-fw"></i>Aprendices</a></li>                            
                        </ul>
                    </li>
                    <li>
                        <div class="dropdown-menu-button"><i class="zmdi fa fa-check-square-o zmdi-hc-fw"></i>&nbsp;&nbsp; ACTUALIZAR ... <i class="zmdi zmdi-chevron-down pull-right zmdi-hc-fw"></i></div>
                        <ul class="list-unstyled">
                            <li><a href="Tabla_Regional.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Actualizar Regionales</a></li>    
                            <li><a href="Tabla_Centro.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Actualizar Centros</a></li>  
                            <li><a href="Tabla_Area.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Actualizar Areas</a></li>  
                            <li><a href="Tabla_Titulacion.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Actualizar Titulaciones</a></li>  
                            <li><a href="Tabla_Ficha.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Actualizar Fichas</a></li>  
                            <li><a href="Tabla_cordinador.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Actualizar Cordinador</a></li>  
                            <li><a href="Tabla_admin_area.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Actualizar Admin Area</a></li>  
                            <li><a href="Actualizar_Instructor.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Actualizar Instructores</a></li>  
                            <li><a href="Actualizar_Aprendices.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Actualizar Aprendices</a></li>  
                        </ul>
                    </li>
                </ul>
            </div>
