        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset nav-lateral-list-menu">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a href="menu_aprendiz_lider.jsp"><i class="zmdi fa fa-home zmdi-hc-fw"></i>&nbsp;&nbsp; INICIO</a>
                    </li>
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="registrar_bitacora.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Bitacora</a></li>
                        </ul>
                    </li>               
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="Actualizar_Bitacora.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Bitacora</a></li>                        
                        </ul>
                    </li>
                </ul>
            </div>
