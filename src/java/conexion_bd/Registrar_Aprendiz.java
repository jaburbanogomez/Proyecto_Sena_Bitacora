 ...
 */
public class Registrar_Aprendiz {
    ...
    public Registrar_Aprendiz(String n_documento_usuario, String nombres_usuario, String apellidos_usuario, String celular_usuario, String correo_usuario, int id_rol, int id_tipo_documento, int id_ficha, int id_estado_usuario) {
