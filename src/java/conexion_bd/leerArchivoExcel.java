 ...
 * @author daniel
 */
public class leerArchivoExcel extends Conexion_bd {
    ...
    public int leerArchivoExcel2(String archivoDestino, String id_ficha) {
        int contador = 1;
        try {
            ...
            for (int hojas = 0; hojas < archivoExcel.getNumberOfSheets(); hojas++) {
                ...
                for (int fila = 1; fila < numFilas; fila++) {
                    ...
                    String sql = "INSERT INTO usuarios(n_documento_usuario,nombres_usuario,apellidos_usuario,celular_usuario,correo_usuario,id_rol,id_tipo_documento,id_ficha,id_estado_usuario)  VALUES ('" + n_Documento + "','" + nombre + "','" +apellidos + "','" + celular + "','" + email + "','" + 6 + "','" + 1 + "','" + id_ficha + "','" + 1+ "')";
