...
<body oncontextmenu="return false">
    <nav class="navbar-user-top full-reset">    
        ...
        <ul class="list-unstyled full-reset">
            ...
            <figure>
                <img src="assets/img/teacher.png" alt="user-picture" class="img-responsive img-circle center-box">
            </figure>
        ...
        <div class="full-reset container-menu-movile custom-scroll-containers">
            ...
            <div class="full-reset nav-lateral-list-menu">
                ...
                <ul class="list-unstyled">
                    <li>
                        <a href="menu_instructor.jsp"><i class="zmdi fa fa-home zmdi-hc-fw"></i>&nbsp;&nbsp; INICIO</a>
                    </li>
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="guardar_inasistencia.jsp"><i class="zmdi material-icons  zmdi-hc-fw">add_circle</i>Inasistencia</a></li>
                        </ul>
                    </li>                                
                    <li>
                        ...
                        <ul class="list-unstyled">
                            <li><a href="Actualizar_inasistencia.jsp"><i class="zmdi fa fa-refresh zmdi-hc-fw"></i>Inasistencia</a></li>
                        </ul>
                    </li>
                    <li>
                        <div class="dropdown-menu-button">
                            <i class="zmdi fa fa-sign-out  zmdi"></i>&nbsp;&nbsp; ASIGNAR... <i class="zmdi zmdi-chevron-down pull-right zmdi-hc-fw"></i></div>
                        <ul class="list-unstyled">
                            <li><a href="Asignar_Aprendiz.jsp"><i class="zmdi material-icons zmdi-hc-fw">add_circle</i>Aprendiz Lider</a></li>
                        </ul>
                    </li>   
                </ul>
            </div>
