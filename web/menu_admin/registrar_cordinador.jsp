...
<html lang="es">
    ...
    <body oncontextmenu="return false">
        ...
        <%
            ...
            if (guardar) {
                Cordinador_CRUD misDatos = new Cordinador_CRUD();// de esta manera tenemos conexion a la base de datos
                Cordinador miCordinador = misDatos.consultarCordinador(n_documento_usuario);
                if (miCordinador != null) {
                    mensaje = "EL CORDINADOR YA SE ENCUENTRO REGISTRADO";
                } else {
                    ...
                    misDatos.nuevoCordinador(miCordinador);
                    mensaje = "CORDINADOR GUARDADO EXITOSAMENTE";
                    n_documento_usuario = "";
                    nombres_usuario = "";
                    apellidos_usuario = "";
                    celular_usuario = "";
        ...
        <div class="content-page-container full-reset custom-scroll-containers" >
            <form class="form-horizontal" action="registrar_cordinador.jsp" method="POST"> 
                <div class="container-fluid">
                    <div class="container-flat-form">
                        <div class="container-fluid">
                            <ul class="nav nav-tabs nav-justified"  style="font-size: 17px;">
                                <li role="presentation"   class="active"><a href="registrar_cordinador.jsp">Registrar Cordinador</a></li>
                        ...
                        <div class="title-flat-form title-flat-blue">Registrar Cordinador</div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-8 col-sm-offset-2">                                
                                <div class="col-md-6">
                                    <div class="group-material">
                                        <input type="text" name="nombres_usuario"  id="nombres_usuario" value="<%=nombres_usuario%>" size="30"  class="material-control tooltips-general input-check-user" placeholder="Ingrese nombres"  data-toggle="tooltip" data-placement="top" title="Escribe nombres" onkeypress="return tabE(this, event)">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Nombres</label>
                                    </div>
                                    <div class="group-material">
                                        <input type="text" name="apellidos_usuario"  id="apellidos_usuario" value="<%=apellidos_usuario%>" size="30"  class="material-control tooltips-general input-check-user" placeholder="Ingrese apellidos"  data-toggle="tooltip" data-placement="top" title="Escribe apellidos" onkeypress="return tabE(this, event)">
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                ...
                                <div class="col-md-6">
                                    <div class="group-material">
                                        <select  name="id_tipo_documento" id="id_tipo_documento" value="<%=id_tipo_documento%>" class="material-control tooltips-general" data-toggle="tooltip"  data-placement="top" title="Elige tipo documento" style="cursor:pointer;" onkeypress="return tabE(this, event)">
                                            <%
                                        ...
                                        <select  name="id_rol" id="id_rol" value="<%=id_rol%>" class="material-control tooltips-general" data-toggle="tooltip"  data-placement="top" title="Elige un rol" style="cursor:pointer;" onkeypress="return tabE(this, event)">
                                            <%
                                                ...
                                                try {
                                                    out.println("<option value=''>:.</option>");
                                                    cn.control();
                                                    String sql = "SELECT id_rol, nombre_rol FROM  rol WHERE  id_rol = 3;";
                                                    cn.st = cn.con.createStatement();
                                                    cn.rt = cn.st.executeQuery(sql);
                                                    while (cn.rt.next()) {
                                                        out.println("<option value='" + cn.rt.getString(1) + "'>" + cn.rt.getString(2) + "</option>");
